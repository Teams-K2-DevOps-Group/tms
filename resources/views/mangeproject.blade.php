...
<body class="bg-gray-100"> 
    <div class="dashboard">
     ...
     <div class="user-profile">
    <h2 class="text-2xl font-bold mb-4">Manage Project</h2> 
    <span class="tmsbtn" style="right:35px !important; position:absolute;" onclick="document.getElementById('id03').style.display='block';                      document.getElementById('id01').style.display='none';document.getElementById('id02').style.display='none'"><i class="fas fa-project-diagram"></i>
                    Create
     </span>
    </div>
        ...
        <table class="min-w-full bg-white border border-gray-300 text-sm text-left" id="itemTable">
            <thead class="bg-gray-200">
                <tr>
                    ...
                    <th class="px-4 py-2 border">Project Names</th>
                    <th class="px-4 py-2 border">Project Descriptions</th>
