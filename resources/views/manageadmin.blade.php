        ...
        <div class="sidebar">
            ...
            <ul class="nav-menu">
                ...
                <li class="nav-item">
                    ...
                    <li>
                    <a href="{{route('manageadmin')}}" class="nav-link active">
...
<div class="user-profile">
	...
	<span style="right:35px !important; position:absolute;" class="tmsbtn" class="tmsbtn" onclick="document.getElementById('id03').style.display='block';                      document.getElementById('id01').style.display='none';                                                           document.getElementById('id02').style.display='none'"><i class="fas fa-plus"></i>
     Add Admin
     </span>
	</div>
    <div class="overflow-x-auto">
        <table id="itemTable" class="min-w-full bg-white border border-gray-300 text-sm text-left">
...
<span onclick="document.getElementById('id01').style.display='none'" class="modelclose" title="Close Delete">×</span>
  ...
  <form class="tmsmodal-content" action="">
    ...
    <p><i class="fas fa-skull-crossbones"></i>
      Are you sure you want to delete your selection?</p>
...
<div class="tmsnavbar">
<h1><i class="fas fa-edit"></i> Edit Selected</h1>
<span onclick="document.getElementById('id02').style.display='none'" class="modelclose" title="Close Edit">×</span>
</div>
  <form class="tmsmodal-content" action="">
    <div class="modalcontainer">
...
<span onclick="document.getElementById('id03').style.display='none'" class="modelclose" title="Close Add Admin">×</span>
</div>
  <form class="tmsmodal-content" action="">
    <div class="modalcontainer">
     <div style="text-align: left !important;">
	...
	<i class="fas fa-user-shield"></i> Add Admin </button>
      </div>
     </div>
  </form>
</div>
