...
<body class="bg-gray-100"> 
        ...
        <div class="sidebar">
            ...
            <ul class="nav-menu">
                ...
                <li class="nav-item">
                    ...
                    <li>
                    <a href="{{route('manageteam')}}" class="nav-link active">
	...
	<div class="user-profile">
        <h2 class="text-2xl font-bold mb-4">Manage Team</h2>
          <span style="right:35px !important; position:absolute;"class="tmsbtn"             onclick="document.getElementById('id03').style.display='block'; document.getElementById             ('id01').style.display='none';document.getElementById('id02').style.display='none'"><i class="fas                fa-users"></i>
                    New Team
                  </span>
	</div>
        ...
        <table class="min-w-full bg-white border border-gray-300 text-sm text-left" id="itemTable">
            <thead class="bg-gray-200">
                <tr>
                    ...
                    <th class="px-4 py-2 border" style="width:180px;">Email</th>
		    <th class="px-4 py-2 border" style="width:180px;">Action</th>
                </tr>
            </thead>
            <tbody id="tmsleftpannel">
      		 <tr class="hover:bg-gray-100" id="tmsSideMenu">
                    ...
                    <td class="px-4 py-2 border">2424547</td>
			...
			<i class="fas fa-trash"></i> Delete
                ...
                <tr class="hover:bg-gray-100">
                    ...
                    <td class="px-4 py-2 border">2423918</td>
			...
			<i class="fas fa-trash"></i> Delete
                ...
                <tr class="hover:bg-gray-100">
                    ...
                    <td class="px-4 py-2 border">2424375</td>
			...
			<i class="fas fa-trash"></i> Delete
                ...
                <tr class="hover:bg-gray-100">
                    ...
                    <td class="px-4 py-2 border">2121514</td>
...
<span onclick="document.getElementById('id01').style.display='none'" class="modelclose" title="Close Delete">×</span>
  ...
  <form class="tmsmodal-content" action="">
    ...
    <p><i class="fas fa-skull-crossbones"></i>
      Are you sure you want to delete selected Team <i class="fas fa-users"></i>?</p>  
...
<div class="tmsnavbar">
<h1><i class="fas fa-users"></i> Edit Team</h1>
<span onclick="document.getElementById('id02').style.display='none'" class="modelclose" title="Close Create Project">×</span>
  ...
  <form class="tmsmodal-content" action="">
	...
	<input type="text" placeholder="Enter Name" style="border:1px solid white; border-radius:5px;  background:transparent; width:100%; padding:5px;" />
	</div>
	<div style="text-align: left !important;">
        ID <i class="fas fa-key"></i>
	<input type="text" placeholder="Enter ID" style="border:1px solid white; border-radius:5px;  background:transparent; width:100%; padding:5px;" />
	</div>
...
<div class="tmsnavbar">
<h1><i class="fas fa-users"></i> New Team</h1>
<span onclick="document.getElementById('id03').style.display='none'" class="modelclose" title="Close Create Project">×</span>
  ...
  <form class="tmsmodal-content" action="">
	...
	<i class="fas fa-users"></i> Save Team </button>
      </div>
     </div>
  </form>
</div>
