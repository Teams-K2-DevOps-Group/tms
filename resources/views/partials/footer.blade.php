<footer class="text-white rounded-lg shadow-sm m-4">
    <div class="w-full max-w-screen-xl mx-auto p-4 md:py-8">
        ...
        <span class="block text-sm text-white sm:text-center"> &copy; {{ date('Y') }} <a href="" class="hover:underline">TMS</a>. All Rights Reserved.</span>
    </div>
</footer>